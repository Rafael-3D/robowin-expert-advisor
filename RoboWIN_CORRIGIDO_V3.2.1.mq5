//+------------------------------------------------------------------+
//|                     RoboWIN - VERSÃO CORRIGIDA V3.2.1            |
//|                     ✅ V3.2 + Módulo de Estatísticas             |
//|                     ⚠️ SEM correção de GAP da V3.3               |
//|                                                                  |
//|                     HISTÓRICO:                                   |
...
//+------------------------------------------------------------------+
#property copyright "Copyright 2026 - V3.2.1 Estável com Stats"
...
{
    Print("╔═══════════════════════════════════════════════════════════╗");
    Print("║     ROBÔ WIN - VERSÃO CORRIGIDA V3.21                     ║");
    Print("║     ✅ V3.2 (estável) + Módulo de Estatísticas            ║");
    ...
    Print("║     ⚠️ V3.3 REJEITADA - Bug crítico no preço              ║");
    Print("╚═══════════════════════════════════════════════════════════╝");
...
//| ⭐ V3.2.1: Logs de limite de tentativas apenas uma vez           |
//+------------------------------------------------------------------+
...
bool ExecutarOrdemMercado(ENUM_ORDER_TYPE tipo)
{
    ...
    bool resultado;
    if (tipo == ORDER_TYPE_BUY) {
        resultado = trade.Buy(contratos, _Symbol, 0, 0, 0, "WIN-V3.21-Mercado");
    } else {
        resultado = trade.Sell(contratos, _Symbol, 0, 0, 0, "WIN-V3.21-Mercado");
    }
