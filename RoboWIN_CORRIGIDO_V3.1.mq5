//+------------------------------------------------------------------+
//|                     RoboWIN - VERSÃO CORRIGIDA V3.1              |
//|                     ✅ CORREÇÕES CRÍTICAS V3.1:                   |
//|                     1. Reset completo após Stop Loss             |
//|                     2. Cancelamento de ordens pendentes pós-stop |
//|                     3. Recolocação de ordens nos níveis originais|
//|                     4. Permite nova entrada após 1º stop         |
//+------------------------------------------------------------------+
#property copyright "Copyright 2026 - V3.1 Correção Pós-Stop"
...
{
    Print("╔═══════════════════════════════════════════════════════════╗");
    Print("║     ROBÔ WIN - VERSÃO CORRIGIDA V3.10                     ║");
    Print("║     ✅ Reset completo após Stop Loss                       ║");
    Print("║     ✅ Cancelamento de ordens pendentes pós-stop           ║");
    Print("║     ✅ Recolocação de ordens nos níveis originais          ║");
    Print("║     ✅ Permite nova entrada após 1º stop                   ║");
    Print("╚═══════════════════════════════════════════════════════════╝");
...
//+------------------------------------------------------------------+
//| ⭐ V3.1: RESET COMPLETO APÓS STOP LOSS                           |
//| Esta função é chamada após um stop loss para permitir nova       |
...
//+------------------------------------------------------------------+
//| ⭐ V3.1: Monitorar níveis com lógica melhorada                   |
//| Agora funciona corretamente após reset pós-stop                  |
//+------------------------------------------------------------------+
...
bool ExecutarOrdemMercado(ENUM_ORDER_TYPE tipo)
{
    ...
    bool resultado;
    if (tipo == ORDER_TYPE_BUY) {
        resultado = trade.Buy(contratos, _Symbol, 0, 0, 0, "WIN-V3.1-Mercado");
    } else {
        resultado = trade.Sell(contratos, _Symbol, 0, 0, 0, "WIN-V3.1-Mercado");
    }
...
//+------------------------------------------------------------------+
//| ⭐ V3.1: Verificar resultado com RESET após stop                 |
//| CORREÇÃO PRINCIPAL: Após stop, reseta para permitir nova entrada |
//+------------------------------------------------------------------+
void VerificarResultadoPosicao()
{
    ...
    //--- BREAKEVEN
        ...
        // ⭐ V3.1: Após breakeven, também permite nova entrada
        Print("\n⚠️ Breakeven atingido - Resetando para permitir nova entrada...");
        ResetarAposStop();
    }
    //--- STOP LOSS
        ...
        // ⭐⭐⭐ V3.1: CORREÇÃO PRINCIPAL ⭐⭐⭐
        // Após stop loss, verificar se ainda pode operar
