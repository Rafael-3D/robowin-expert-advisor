//+------------------------------------------------------------------+
//|                     RoboWIN - VERSÃO CORRIGIDA V3.2.4            |
//|                     ✅ V3.2.3 + Otimização de Logs                |
//|                                                                  |
//|                     HISTÓRICO:                                   |
...
//+------------------------------------------------------------------+
#property copyright "Copyright 2026 - V3.2.4 com Otimização de Logs"
...
{
    Print("╔═══════════════════════════════════════════════════════════╗");
    Print("║     ROBÔ WIN - VERSÃO CORRIGIDA V3.2.4                    ║");
    Print("║     ✅ V3.2.3 + Otimização de Logs                        ║");
...
bool ExecutarOrdemMercado(ENUM_ORDER_TYPE tipo)
{
    ...
    bool resultado;
    if (tipo == ORDER_TYPE_BUY) {
        resultado = trade.Buy(contratos, _Symbol, 0, 0, 0, "WIN-V3.24-Mercado");
    } else {
        resultado = trade.Sell(contratos, _Symbol, 0, 0, 0, "WIN-V3.24-Mercado");
    }
