//+------------------------------------------------------------------+
//|                     RoboWIN - VERSÃO CORRIGIDA V3.2.3            |
//|                     ✅ V3.2.2 + Filtro Proximidade                |
//|                                                                  |
//|                     HISTÓRICO:                                   |
...
//+------------------------------------------------------------------+
#property copyright "Copyright 2026 - V3.2.3 com Filtro Proximidade"
...
{
    Print("╔═══════════════════════════════════════════════════════════╗");
    Print("║     ROBÔ WIN - VERSÃO CORRIGIDA V3.2.3                    ║");
    Print("║     ✅ V3.2.2 + Filtro de Proximidade                      ║");
    ...
    if (!compraExecutada && !ordemCompraPendente) {
        ...
        if (precoAtual > pontoCompra1) {
            ...
            if (distancia <= distanciaProximidade) {
                ...
                // Log controlado - máximo 1x por minuto
...
bool ExecutarOrdemMercado(ENUM_ORDER_TYPE tipo)
{
    ...
    bool resultado;
    if (tipo == ORDER_TYPE_BUY) {
        resultado = trade.Buy(contratos, _Symbol, 0, 0, 0, "WIN-V3.23-Mercado");
    } else {
        resultado = trade.Sell(contratos, _Symbol, 0, 0, 0, "WIN-V3.23-Mercado");
    }
