...
> 
> Leia [AVISOS_IMPORTANTES.md](AVISOS_IMPORTANTES.md) para detalhes.
...
├─────────────────────────────────────────────────────────────┤
│  BUY_LIMIT:  Preço limite < Preço atual (comprar na queda)  │
│  SELL_LIMIT: Preço limite > Preço atual (vender na alta)    │
├─────────────────────────────────────────────────────────────┤
...
Baixe o arquivo `RoboWIN_CORRIGIDO_V3.mq5` deste repositório.

> ⚠️ **IMPORTANTE:** Use APENAS o arquivo V3! NÃO use `RoboWIN_CORRIGIDO.mq5` (V2.00).
...
```
C:\Users\[SeuUsuário]\AppData\Roaming\MetaQuotes\Terminal\[ID_Instalação]\MQL5\Experts\
```
...
2. Abra o arquivo `RoboWIN_CORRIGIDO_V3.mq5`
...
**Logs esperados:**
```
09:15:42 ❌ BUY_LIMIT inválido: preço 187620 > preço atual 187300
...
09:15:42 ╚═══════════════════════════════════════════════════════════╝
09:15:42 📋 Tipo: BUY_LIMIT
09:15:42 📋 Preço limite: 189700
09:15:42 📋 Preço atual: 189750
09:15:42 ✅ BUY_LIMIT válido (preço limite < preço atual)
...
3. Configure:
   - Expert Advisor: `RoboWIN_CORRIGIDO_V3`
...
⚠️ **Validação V3:**
```
❌ BUY_LIMIT inválido: preço limite deve ser < preço atual
...
| Cenário | V2.00 | V3.00 |
|---------|-------|-------|
| Ordem BUY_LIMIT com preço acima do mercado | Envia e é rejeitada | Detecta e não envia |
...
- **[AVISOS_IMPORTANTES.md](AVISOS_IMPORTANTES.md)** - Por que NÃO usar V2
- **[CHANGELOG.md](CHANGELOG.md)** - Histórico completo de versões
- **[ANALISE_LOG.md](ANALISE_LOG.md)** - Análise detalhada dos bugs da V2
- **[CORRECOES_DETALHADAS.md](CORRECOES_DETALHADAS.md)** - Detalhes técnicos
...
2. ✅ Leia [AVISOS_IMPORTANTES.md](AVISOS_IMPORTANTES.md)
3. ✅ Consulte [ANALISE_LOG.md](ANALISE_LOG.md)
